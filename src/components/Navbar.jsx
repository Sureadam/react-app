    ...
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}> 
          <AiOutlineClose size={30} className="absolute right-4 top-6 cursor-pointer" onClick={() => setNav(!nav)}/>
          <h2 className="text-2xl p-6">Best <span className="font-bold">Eats</span></h2>
          <nav>
            <ul className="flex flex-col p-4 text-gray-800">
              ...
              <li className="text-xl py-4 flex items-center"><FaWallet size={25} className="mr-4"/>Wallets</li>
